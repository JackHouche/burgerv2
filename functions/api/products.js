    ...
    const productsData = [
      {
        ...
        ingredients: [
          ...
          { id: 2, name: 'Fromage cheddar aged', isRemovable: true, sortOrder: 2 },
          { id: 3, name: 'Salade iceberg', isRemovable: true, sortOrder: 3 },
          { id: 4, name: 'Tomate', isRemovable: true, sortOrder: 4 },
          { id: 5, name: 'Oignons caramélisés', isRemovable: true, sortOrder: 5 },
      ...
      },
      {
        ...
        isAvailable: true,
        ingredients: [
          { id: 12, name: 'Steak végétarien', isRemovable: false, sortOrder: 1 },
